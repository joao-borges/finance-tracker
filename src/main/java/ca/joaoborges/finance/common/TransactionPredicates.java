...
/**
 * The flag-semantics table from {@code DESIGN.md}, expressed once as reusable JPQL
...
public final class TransactionPredicates {
    ...
    /**
     * Budget "actual spent": visible rows not excluded from budget and not flagged
     * as awaiting a refund (known-future refunds drop out of the current budget).
     */
    public static final String COUNTS_IN_BUDGET =
            VISIBLE_IN_LIST + " AND t.excludedFromBudget = false AND t.awaitingRefund = false";
